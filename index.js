...
var Event = function (_React$Component) {
  ...
  function Event(props) {
    ...
    if (_this.props.float) {
      ...
      _this.draggingPosition = { time: time, lineId: line ? line.id : undefined };

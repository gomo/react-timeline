...
/***/ function(module, exports, __webpack_require__) {
	...
	var target = {
	  ...
	  hover: function hover(props, monitor, component) {
	    ...
	    if (clientOffset) {
	      var eventComponent = props.timeline.actions.findEventByProps(monitor.getItem());
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.events.map(function (event) {
	            return _react2.default.createElement(_Event2.default, {
	              ...
	              onClickEvent: _this4.props.onClickEvent
	            });
	          })
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventBase = __webpack_require__(146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var source = {
	  ...
	  canDrag: function canDrag(props, monitor) {
	    var draggable = props.timeline.actions.findEventByProps(props).state.draggable;
	    return !!draggable;
	  }
	};

	  ...
	  _createClass(Frame, [{
	    ...
	    value: function resizeTop(eventComponent, clickedTop) {
	      ...
	      var mouseUpEvent = function mouseUpEvent() {
	        ...
	        _this2.refs.linesWrapper.removeEventListener('mouseup', mouseUpEvent);

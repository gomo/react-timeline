	  ...
	  _createClass(Line, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)('tlLineView', { even: this.props.even, odd: !this.props.even }), style: this.wrapperStyle, onClick: function onClick(e) {

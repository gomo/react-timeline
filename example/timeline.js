	...
	var Actions = function () {
	  ...
	  _createClass(Actions, [{
	    ...
	    value: function getTotalWidth() {
	      return this.widths.reduce(function (prev, current) {
	        return prev + current;
	      }, 0);
	    }
	  }, {
	    ...
	    key: "addWidth",
	    value: function addWidth(index, width) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Frame = function (_React$Component) {
	  ...
	  function Frame(props) {
	    ...
	    _this.props.timeline.actions.frame = _this;
	    ...
	    props.lineData.forEach(function (data, index) {
	      ...
	      if (currentKey === 0) {
	        ...
	        _this.props.timeline.actions.addWidth(index, _Ruler2.default.width);
	      ...
	      _this.state.lines.push(_react2.default.createElement(_Line2.default, {
	        ...
	        height: _this.props.timeline.actions.lineHeight,
	        minHeight: _this.props.minHeight,
	        timeSpan: _this.props.timeSpan,
	        onClick: _this.props.onClick,
	        even: index % 2 !== 0,
	        timeline: _this.props.timeline
	      }));
	
	      _this.props.timeline.actions.addWidth(index, _this.props.lineWidth);
	    });
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Line = function (_React$Component) {
	  ...
	  function Line(props) {
	    ...
	    _this.props.timeline.actions.addLine(_this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashIsArray = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Event = function (_React$Component) {
	  ...
	  function Event(props) {
	    ...
	    _this.props.timeline.actions.addEvent(_this);
	    return _this;
	  }

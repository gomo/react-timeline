	        ...
	        if (targetHeight > 36) {
	          ...
	          if (targetTop >= prevBottom) {
	            ...
	            eventComponent.setState({
	              height: _this2.props.timeline.timeSpanToHeight(eventComponent.resizableTimeSpan),
	              top: _this2.props.timeline.timeToTop(eventComponent.resizableTimeSpan.getStartTime()),
	      ...
	      var mouseMoveEvent = function mouseMoveEvent(moveEvent) {
	        ...
	        if (targetHeight > 36) {
	          ...
	          if (targetBottom < nextTop) {
	            ...
	            eventComponent.setState({
	              height: _this3.props.timeline.timeSpanToHeight(eventComponent.resizableTimeSpan),

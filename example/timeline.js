	...
	var Actions = function () {
	  ...
	  _createClass(Actions, [{
	    ...
	    value: function topToTime(top) {
	      ...
	      var rest = minute % this.minInterval;
	      if (rest !== 0) {

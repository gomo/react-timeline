...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  var timeline = _reactDom2.default.render(React.createElement(_index.Timeline, {
	    ...
	    onClickFlexibleEvent: function onClickFlexibleEvent(event) {
	...
	var Timeline = function (_React$Component) {
	  ...
	  _createClass(Timeline, [{
	    ...
	    value: function findPrevEvent(eventComponent) {
	      ...
	      .sort(function (a, b) {
	        return -a.timeSpan.getStartTime().compare(b.timeSpan.getStartTime());
	      }) //時間の降順で並び替え
	      .find(function (ev) {
	        return ev.timeSpan.getStartTime().compare(eventComponent.timeSpan.getStartTime()) < 0;
	...
	var Frame = function (_React$Component) {
	  ...
	  _createClass(Frame, [{
	    ...
	    value: function resizeTop(eventComponent, clickedTop) {
	      ...
	      var mouseMoveEvent = function mouseMoveEvent(moveEvent) {
	        ...
	        if (targetHeight > 36) {
	          ...
	          if (targetTop >= prevBottom) {
	            eventComponent.resizableTimeSpan = new _TimeSpan2.default(_this2.props.timeline.topToTime(targetTop), eventComponent.currentTimeSpan.getEndTime());
	      ...
	      var stopMoveEvent = function stopMoveEvent() {
	      ...
	      this.refs.linesWrapper.addEventListener('mouseleave', function () {
	        stopMoveEvent();
	    ...
	    value: function resizeDown(eventComponent, clickedTop) {
	      ...
	      var mouseMoveEvent = function mouseMoveEvent(moveEvent) {
	        ...
	        if (targetHeight > 36) {
	          ...
	          eventComponent.resizableTimeSpan = new _TimeSpan2.default(eventComponent.currentTimeSpan.getStartTime(), _this3.props.timeline.topToTime(targetBottom));
	          eventComponent.setState({
	            height: targetHeight,
	      ...
	      var mouseUpEvent = function mouseUpEvent() {
	        ...
	        _this3.refs.linesWrapper.removeEventListener('mouseup', mouseUpEvent);
	        eventComponent.endHandling();
	      };
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.events.map(function (event) {
	            return _react2.default.createElement(_Event2.default, {
	              ...
	              onClickFlexibleEvent: _this5.props.onClickFlexibleEvent
	            });
	          })
	        ),
	  ...
	  _createClass(Event, [{
	    ...
	    value: function render() {
	      ...
	      return this.props.connectDragSource(_react2.default.createElement(
	        'div',
	        { on: true, className: (0, _classnames2.default)('tlEventView', { tlDraggingEvent: this.state.draggable, tlFlexibleEvent: this.state.resizable }), style: style, onClick: function onClick(e) {

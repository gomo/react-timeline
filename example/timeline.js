	    ...
	    value: function resizeTop(eventComponent, clickedTop) {
	      ...
	      var mouseMoveEvent = function mouseMoveEvent(moveEvent) {
	        ...
	        if (targetHeight > 36) {
	          ...
	          eventComponent.flexibleTimeSpan = new _TimeSpan2.default(_this2.props.timeline.topToTime(targetTop), eventComponent.currentTimeSpan.getEndTime());
	    ...
	    value: function resizeDown(eventComponent, clickedTop) {
	      ...
	      var mouseMoveEvent = function mouseMoveEvent(moveEvent) {
	        ...
	        if (targetHeight > 36) {
	          ...
	          eventComponent.flexibleTimeSpan = new _TimeSpan2.default(eventComponent.currentTimeSpan.getStartTime(), _this3.props.timeline.topToTime(targetBottom));
	          eventComponent.setState({
	            height: targetHeight,
	  ...
	  _createClass(Event, [{
	    ...
	    value: function render() {
	      ...
	      return this.props.connectDragSource(_react2.default.createElement(
	        'div',
	        { on: true, className: (0, _classnames2.default)('tlEventView', { tlDraggingEvent: this.state.draggable, tlFlexibleEvent: this.state.flexible }), style: style, onClick: function onClick(e) {
	            return _this3.onClick(e);
	          } },
	        function () {
	          if (_this3.state.flexible) {
	            return _react2.default.createElement(
	              'div',
